...
class TestNovaAPI(tests.FunctionalTest):
    ...
    test_101_check_limits.tags = ['olympus', 'nova']

    def test_102_verify_version_selection_json(self):
        path = "http://%s:%s/%s/.json" % (self.nova['host'],
                                           self.nova['port'],
                                           self.nova['ver'])
        http = httplib2.Http()
        headers = {'X-Auth-Token': self.nova['X-Auth-Token']}
        ...
        data = json.loads(content)
        self.assertEqual(len(data['versions']), 2)
    test_102_check_limits.tags = ['olympus', 'nova']

    def test_103_bad_user_bad_key(self):
        path = "http://%s:%s/%s/" % (self.nova['host'],
                                           self.nova['port'],
                                           self.nova['ver'])
        http = httplib2.Http()
    ...
    test_103_check_limits.tags = ['olympus', 'nova']

    def test_104_bad_user_good_key(self):
        path = "http://%s:%s/%s/" % (self.nova['host'],
                                           self.nova['port'],
                                           self.nova['ver'])
        http = httplib2.Http()
        ...
        response, content = http.request(path, 'GET', headers=headers)
        self.assertEqual(response.status, 401)
    test_104_check_limits.tags = ['olympus', 'nova']

    def test_105_good_user_bad_key(self):
        path = "http://%s:%s/%s/" % (self.nova['host'],
                                           self.nova['port'],
                                           self.nova['ver'])
        http = httplib2.Http()
        ...
        response, content = http.request(path, 'GET', headers=headers)
        self.assertEqual(response.status, 401)
    test_105_check_limits.tags = ['olympus', 'nova']

    def test_106_no_key(self):
        path = "http://%s:%s/%s/" % (self.nova['host'],
                                           self.nova['port'],
                                           self.nova['ver'])
        http = httplib2.Http()
        ...
        response, content = http.request(path, 'GET', headers=headers)
        self.assertEqual(response.status, 401)
    test_106_check_limits.tags = ['olympus', 'nova']

    def test_107_bad_token(self):
        path = "http://%s:%s/%s/" % (self.nova['host'],
                                           self.nova['port'],
                                           self.nova['ver'])
        http = httplib2.Http()
        ...
        response, content = http.request(path, 'GET', headers=headers)
        self.assertEqual(response.status, 401)
    test_107_check_limits.tags = ['olympus', 'nova']

    def test_108_check_limits(self):
    ...
    test_108_check_limits.tags = ['olympus', 'nova']

    def test_109_list_flavors_v1_1(self):
    ...
    test_109_list_flavors_v1_1.tags = ['olympus', 'nova']

    def test_110_verify_kernel_active_v1_1(self):
    ...
    test_110_verify_kernel_active_v1_1.tags = ['olympus', 'nova']

    def test_111_verify_ramdisk_active_v1_1(self):
        ...
        data = json.loads(content)
        self.assertEqual(data['image']['status'], 'ACTIVE')
    test_111_verify_ramdisk_active_v1_1.tags = ['olympus', 'nova']

    def test_112_verify_image_active_v1_1(self):
        ...
        data = json.loads(content)
        self.assertEqual(data['image']['status'], 'ACTIVE')
    test_112_verify_image_active_v1_1.tags = ['olympus', 'nova']
